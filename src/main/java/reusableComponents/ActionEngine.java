...
public class ActionEngine {
    ...
    public void assertIncludeString_custom(String expvalue, String actualValue, String locatorName) throws Throwable {
        try {
    ...
    public void opemNewTab(String url) {
        try {
            ...
            ExtentFactory.getInstance().getExtent().log(Status.FAIL, url + "==> opened in a new tab");
        } catch (Exception e) {
            ExtentFactory.getInstance().getExtent().log(Status.FAIL, url + "==> did not open in new tab due to exception: " + e);
        }
    }
}